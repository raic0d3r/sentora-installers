...
if [[ "$OS" = "CentOs" ]]; then
    ...
    $PACKAGE_INSTALLER libapache2-mod-php libphp-embed php-bz2 php-cli php-common php-curl php-fpm php-pear php-gd php-intl php-json php-mbstring php-mcrypt php-mysql php-opcache php-pgsql php-phpdbg php-readline php-xml php-zip php-bcmath php-cgi php-dba php-dev php-enchant php-gmp php-imap php-interbase php-ldap php-odbc php-pspell php-recode php-snmp php-soap php-sqlite3 php-sybase php-tidy php-xmlrpc php-xsl 
    if [ "$VER" = "14.04" ]; then
